...
Thế đấy, tôi sẽ bắt đầu chỉa sẽ những repo tiếng việt lên `Github` để tất cả những developer là người Việt có thể tìm hiểu, đọc được và cùng nhau đóng góp. Xây dựng lên một cộng đồng developer Việt Nam ngày càng tốt hơn. Tôi không nhận mình giỏi, hoặc code tôi là đúng, là hợp lý hoàn toàn, nhưng nó **hoạt động** và tôi tin sẽ có người cần tới nó. Nội dung tôi chia sẻ thời gian đầu sẽ là những gì liên quan tới `Java Backend`, `Spring Boot` và những thứ xung quanh nó như `spring cloud, spring contract, aop, jpa, hibernate, es, docker, redis v.v..` Đây đều là những kiến thức **cực kì cần học**. Tôi sẽ làm thêm một cái notebook nữa để đánh dấu các phần cho dễ.
